...
public:
    ...
    friend ostream &operator<<(ostream &os, const Creature &creature) {
        os << " base_attack: " << creature.base_attack << " base_defense: "
...
public:
    ...
    friend ostream &operator<<(ostream &os, const Goblin &goblin) {
        os << static_cast<const Creature &>(goblin);
        return os;
    }
...
int main()
{
    ...
    cout << "Checking that a baseline goblin is a 1/1... " << " " << goblin.get_attack() << " " << goblin.get_defense();



    Goblin goblin2{game};
    game.creatures.push_back(&goblin2);
    cout << "Adding a second goblin, now they should be 1/2... " << " " << goblin.get_attack() << " " << goblin.get_defense();


    GoblinKing goblin3{game};
    game.creatures.push_back(&goblin3);
    cout << "Adding a goblin king, now a goblin should be 2/3... " << " " << goblin.get_attack() << " " << goblin.get_defense();
}